...
public class CustomView extends View {
    ...
    private void attributeSet(Context context, AttributeSet attrs) {
        ...
        try {
            columnWidth = typedArray.getInteger(R.styleable.CustomView_column_width, 40);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void init() {
        ...
        paintLine.setColor(ContextCompat.getColor(getContext(), R.color.colorBlack));
        paintLine.setStrokeWidth(5);
        paintLine.setAntiAlias(true);

        paintColumn.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
        paintColumn.setAntiAlias(true);

        paintColumn1.setColor(ContextCompat.getColor(getContext(), R.color.colorCyanA700));
        paintColumn1.setAntiAlias(true);

        paintColumn2.setColor(ContextCompat.getColor(getContext(), R.color.colorHeader));
        paintColumn2.setAntiAlias(true);

        paintRect.setColor(ContextCompat.getColor(getContext(), R.color.colorWhite));
    }
    ...
    private void drawText(Canvas canvas) {
        ...
        //Draw Text Max Values
        canvas.drawText(String.valueOf(max / 2).concat(getResources().getString(R.string.tv_canvas_km)), 0, getHeight() / 2 - max, paintText);
    }
