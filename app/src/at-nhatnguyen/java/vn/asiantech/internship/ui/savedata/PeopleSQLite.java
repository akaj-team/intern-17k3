...
public class PeopleSQLite extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_EMPLOYEE = "CREATE TABLE " + TABLE_NAME_EMPLOYEE + "( "
            + EMPLOYEE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + EMPLOYEE_US + " INTEGER NOT NULL, "
            + EMPLOYEE_COM + " INTEGER NOT NULL, "
            + "FOREIGN KEY (" + EMPLOYEE_US + ") REFERENCES " + TABLE_NAME_PEOPLE + "(" + PEOPLE_ID + "), "
            + "FOREIGN KEY (" + EMPLOYEE_COM + ") REFERENCES " + TABLE_NAME_COMPANY + "(" + COMPANY_ID + "))";
